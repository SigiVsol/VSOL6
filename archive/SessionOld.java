...
//
//    public SessionOld(JSONObject jsonDefaults, Map<String, String> params) {
//        this(jsonDefaults, params, null, null, null, null);
//    }
//
//    public SessionOld(JSONObject jsonDefaults, Map<String, String> params, DbService dbService, LocalSystem system) {
//        this(jsonDefaults, params, dbService, system, null, null);
//    }
//
//    public SessionOld(JSONObject jsonDefaults, Map<String, String> params, DbService dbService, LocalSystem system, Organization organization, User user) {
//        this.db = dbService;
//        this.system = system;
