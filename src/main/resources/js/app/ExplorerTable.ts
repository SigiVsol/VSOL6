    ...
    private fillClients() : void {
        ...
        API.getJson(this.createUrl("clients"), json => {
            ...
            for (let client of Client.fromRows(json.rows)) {
                ...
                tbody += "<td>" + client.getName() + "</td>";
                tbody += "<td>" + client.getVia() + "</td>";
                tbody += "<td>" + client.getAddress() + "</td>";
                tbody += "<td>" + this.getClientActionButtons() + "</td>";
                tbody += "</tr>\n";
            }

            $("#divExplorer .table-clients").css("display", "block");
            $("#divExplorer .table-clients tbody").html(tbody);
        });
    }
