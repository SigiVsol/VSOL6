        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (startTable) {
                    ...
                    String name = row[2];
                    boolean retired = row[3].equals("Retired");

                    result.append(tag).append(";").append(vr).append(";").append(name).append(";").append(retired).append("\n");
...
//                    result.append("),\n");
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream("C:/Sandbox/dicom/DicomTags.csv")) {
